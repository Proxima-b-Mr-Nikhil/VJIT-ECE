...
public class vjitpage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vjitpage);
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String s, final String s1, final String s2, final String s3, long l) {
                ...
                Dexter.withActivity(vjitpage.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(vjitpage.this, "Downloading File..", Toast.LENGTH_SHORT).show();
    ...
    public void checkConnection(){
        ...
        String webUrl = intent.getStringExtra("message");
